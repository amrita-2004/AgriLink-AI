          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                AgriLink_AI connects farmers and FPOs directly with consumers, retailers, restaurants, and bulk buyers while using AI-powered demand forecasting, intelligent fair pricing, and smart logistics to create a fairer and more efficient agricultural supply chain.
              </p>
              ...
              <div className="relative rounded-3xl bg-slate-900 text-white p-6 shadow-2xl border border-slate-800 space-y-5">
                ...
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs font-bold text-slate-400 ml-2">AgriLink_AI Live Engine</span>
                  </div>
                ...
                <div className="p-4 rounded-2xl bg-slate-800/80 border border-slate-700/80 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs">
                    ...
                    <div>
                      <span className="text-slate-400">AgriLink_AI Fair Price:</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12">
          ...
          <p className="text-sm sm:text-base text-slate-600">
            AgriLink_AI replaces guesswork and predatory cartels with predictive data science tailored for Indian and global agriculture.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-white">
              How AgriLink_AI Works from Harvest to Delivery
            </h2>
